...
const COUNTRIES = [
  { key:'ru', flag:'🇷🇺', label:'Россия', drinks:[
    ...
    ['Gorilla Мохито','can'],
    ['Gorilla Zero Sugar','can'],
    ['Go Champ Original','can'],
    ['Go Champ Арбуз-Грейпфрут','can'],
    ['Go Champ Манго-Баобаб','can'],
    ['Go Champ Гуава-Черника','can'],
    ['HotCat Original','can'],
    ['Invoke Original','can'],
    ...
    ['Monster Energy Aussie Lemonade','can'],
    ['Monster Energy Ultra Black','can'],
    ...
    ['Monster Energy Ultra Violet','can'],
...
const CURATED_PHOTOS = [
  ...
  // Дополнения из актуальной выдачи Ozon — один вкус на карточку, без дублей упаковок.
  { match:'Go Champ Original', exact:true, url:'assets/images/go-champ-original.jpg' },
  { match:'Go Champ Арбуз-Грейпфрут', exact:true, url:'assets/images/go-champ-watermelon-grapefruit.webp' },
  { match:'Go Champ Манго-Баобаб', exact:true, url:'assets/images/go-champ-mango-baobab.png' },
  { match:'Go Champ Гуава-Черника', exact:true, url:'assets/images/go-champ-guava-blueberry.jpg' },
  { match:'Gorilla Zero Sugar', exact:true, url:'assets/images/gorilla-zero-sugar.jpg' },
  { match:'Monster Energy Aussie Lemonade', exact:true, url:'assets/images/monster-aussie-lemonade.jpg' },
  { match:'Monster Energy Ultra Black', exact:true, url:'assets/images/monster-ultra-black.jpg' },
  { match:'Monster Energy Ultra Gold', exact:true, url:'assets/images/monster-ultra-gold.png' },
  { match:'Monster Energy Ultra Violet', exact:true, url:'assets/images/monster-ultra-violet.png' },
  ...
  { match:'Volt Energy Малина-Личи', exact:true, url:'assets/images/volt-raspberry-lychee.jpg' },
